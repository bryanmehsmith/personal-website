...
export const summaryParagraphs = [
  ...
  'I adapt quickly. I pivoted from actuarial and financial mathematics into data, then learned each new stack on the job - Ab Initio and Teradata at First National Bank, then Azure, Microsoft Fabric, and AI tooling at Peregrine.',
  'I have since grown into technical leadership and software engineering: mentoring and onboarding team members, setting technical direction, and building internal web applications and tooling. My delivery standards are pragmatic - secure access patterns, automated deployments, and proactive alerting - so teams move fast without trading away reliability.',
];
